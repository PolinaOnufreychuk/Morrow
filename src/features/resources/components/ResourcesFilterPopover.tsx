...
import type { ResourceCategoryFilter, ResourceSort } from "../types";
...
export interface ResourcesFilterPopoverProps {
  categories: FilterOption<ResourceCategoryFilter>[];
  category: ResourceCategoryFilter;
  onCategoryChange: (value: ResourceCategoryFilter) => void;
  sortOptions: FilterOption<ResourceSort>[];
  sort: ResourceSort;
...
/**
 * Filter popover for the Resources list: single-select category list +
