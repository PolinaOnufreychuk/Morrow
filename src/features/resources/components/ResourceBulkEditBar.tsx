...
export interface ResourceBulkEditBarProps {
...
/**
 * Floating action bar shown when one or more resources are multi-selected
 * in Edit Mode. Mirrors `ProjectBulkEditBar`'s glass surface, but Resources
 * only supports bulk Delete (no bulk archive).
 */
export function ResourceBulkEditBar({
  selectedCount,
  onDeleteSelected,
  onClearSelection,
  isBusy = false,
  className,
}: ResourceBulkEditBarProps) {
