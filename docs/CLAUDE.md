...
- **Teams/monetization**: not in MVP. Data model must allow adding workspaces/collaboration later without a rearchitecture (see [DATABASE.md](DATABASE.md)). Monetization has zero influence on MVP implementation.
...
- [PRODUCT.md](PRODUCT.md) — problem, target user, value proposition, scope boundaries
- [ROADMAP.md](ROADMAP.md) — phased build plan (MVP → post-MVP)
- [DATABASE.md](DATABASE.md) — schema, RLS, storage design
- [FEATURES.md](FEATURES.md) — feature list by module, MVP vs later
